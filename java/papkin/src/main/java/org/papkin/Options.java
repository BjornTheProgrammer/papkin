...
public class Options {
    ...
    public static OptionSet defaultOptions() throws Exception {
        OptionParser parser = new OptionParser() {
            {
                ...
                this.accepts(
                        "log-pattern",
                        "Specifies the log filename pattern"
                    )
                    .withRequiredArg()
                    .ofType(String.class)
                ...
                this.acceptsAll(
                        asList("b", "bukkit-settings"),
                        "File for bukkit settings"
                    )
                    .withRequiredArg()
                    .ofType(File.class)
                ...
                this.accepts(
                    "forceUpgrade",
                    "Whether to force a world upgrade"
                );
                this.accepts(
                    "eraseCache",
                ...
                this.accepts(
                    "recreateRegionFiles",
                    "Whether to recreate region files during world upgrade"
                );
                this.accepts(
                    "safeMode",
                ...
                this.acceptsAll(
                        asList("S", "spigot-settings"),
                        "File for spigot settings"
                    )
                    .withRequiredArg()
                    .ofType(File.class)
                ...
                this.acceptsAll(
                        asList("paper-dir", "paper-settings-directory"),
                        "Directory for Paper settings"
                    )
                    .withRequiredArg()
                    .ofType(File.class)
                    .defaultsTo(new File("paper-settings.yml"))
                    .describedAs("Config directory");

                this.acceptsAll(
                        asList("paper", "paper-settings"),
                        "File for Paper settings"
                    )
                    .withRequiredArg()
                    .ofType(File.class)
                ...
                this.acceptsAll(
                        asList("add-plugin", "add-extra-plugin-jar"),
        ...
        try {
            ...
            Logger.getLogger("LoadPlugins").log(
                Level.SEVERE,
